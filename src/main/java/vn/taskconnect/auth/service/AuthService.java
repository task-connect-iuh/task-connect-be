...
public class AuthService {
    ...
    public AuthService(AuthAccountRepository accountRepository, AuthAccountRoleRepository accountRoleRepository,
            ...
            AuthEmailVerificationTokenRepository verificationTokenRepository, PasswordEncoder passwordEncoder,
    ...
    public TokenResponse register(RegisterRequest request) {
        ...
        return issueTokens(account, request.roles());
    }

    /**
     * Dang nhap khong bi chan boi status UNVERIFIED - chi chan LOCKED (dang trong thoi gian
     * khoa) hoac SUSPENDED. TokenResponse tra kem status de client hien nhac xac minh email.
     * Quyet dinh nay da xac nhan voi nguoi dung trong phien lam viec tao file nay.
     *
    ...
    public TokenResponse refresh(String rawRefreshToken) {
        ...
        AuthRefreshToken stored = refreshTokenRepository.findByTokenHash(hash(rawRefreshToken))
